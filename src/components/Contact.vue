        ...
        <form @submit.prevent="submitForm">
          <div class="space-y-12">
            <div class="border-b border-gray-900/10 pb-12">
              <h2 class="text-2xl font-bold leading-7 text-gray-900">GET IN TOUCH!</h2>
              <p class="mt-2 text-sm leading-6 text-gray-600">
                Connect with me for job opportunities, collaborations, or any inquiries. I look forward to hearing from you!
              </p>
                ...
                <div class="sm:col-span-3">
                  ...
                  <div class="mt-2">
                    <input 
                      ...
                      type="text" 
                      name="first-name" 
                      class="w-full rounded-md py-1.5 text-gray-900 ring-1 ring-inset ring-gray-300 
